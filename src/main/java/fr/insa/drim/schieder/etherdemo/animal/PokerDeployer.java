...
public class PokerDeployer {
    ...
    public Poker transferContract () throws Exception {
        ...
        return Poker.deploy(web3, credentials, DefaultGasProvider.GAS_PRICE, DefaultGasProvider.GAS_LIMIT).send();
    }
}
